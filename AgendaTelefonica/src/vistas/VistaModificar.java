...
public class VistaModificar extends javax.swing.JFrame {
    ...
    // Atributos
    Contacto c;           // Contacto a modificar
    VistaContactos vc;    // Referencia a la vista de contactos

    /**
     * Constructor de la clase VistaModificar.
     * 
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // Cerrar la ventana de modificar y mostrar la vista de contactos
        this.dispose();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (!tfNombre.getText().equals("") && !tfApellido.getText().equals("")) {
            ...
            this.dispose();
            this.vc.setVisible(true);
            this.vc.mostrarDatos();  // Actualizar la tabla en la vista de contactos
        } else {
